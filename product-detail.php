...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/1.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Ganesha ancient statue</h1>
          <h4>$249.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Brass Ganesha Statue 24 cm Brass Ganesh Sculpture Religious Home Temple Altar Decor Hindu Elephant God & Good Luck Gift for New Beginnings.
</p>
        </div>
    </div>
    </div>
