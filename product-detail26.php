...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/Marble Sculpture/6.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Art Deco Bronze Hunter & Eagle by Michel Decoux</h1>
          <h4>$1295.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>This rare and unusual bronze sculpture by Belgium artist Michel Decoux is mounted on a fabulous Art Deco 2 tiered angled marble base.
</p>
        </div>
    </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="footer-col-4">
            ...
            <ul>
              <a href="https://www.facebook.com/profile.php?id=100090602011543"<li>Facebook</li></a>
              <a href="https://www.instagram.com/mr.dvyrj"><li>Instagram</li></a>
              <a href="https://www.linkedin.com/in/divyarajsingh-jadeja-85b2a425b/"><li>LinkedIn</li></a>
            </ul>
          </div>
        </div>
        <hr>
