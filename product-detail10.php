...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/11.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Guru Rinpoche, 12" inch Statue, Fully Gold Plated </h1>
          <h4>$1499.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Copper statue of Guru Rinpoche Padmasambhava gilded with 24 carat gold, sculpted and hand painted with gold leaf in Nepal.
</p>
        </div>
    </div>
    </div>
