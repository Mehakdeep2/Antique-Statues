...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/18.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Bust of Apollo Marble Sculpture - Roman Greek God Bust Head Bonded Marble Handmade in Europe - 32cm / 12.6" - Home Decor - The Ancient Home</h1>
          <h4>$1100.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Bust of Apollo inspired by the most celebrated ancient marble sculpture of the God of archery, music and poetry. This ancient Roman statue is now housed in the Pio-Clementine Museum (Vatican Museums), Rome, Italy. 
</p>
        </div>
    </div>
    </div>
