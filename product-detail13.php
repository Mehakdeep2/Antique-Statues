...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/14.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Vajrayogini Brass Statue</h1>
          <h4>$444.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Vajrayogini (Vajravarahi) Brass Statuette Travel Altar Meditation Diety Shrine Statue. This statue is hand cast, ornately detailed solid brass with a silver tone and a dark patina.
</p>
        </div>
    </div>
    </div>
