...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/7.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Porcelain Gautama Buddha Statue Decorative Set with LED light </h1>
          <h4>$350.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Porcelain Buddha Statue with a wood platform and LED arch decoration. Ideal for home and office decoration or meditation purposes.
</p>
        </div>
    </div>
    </div>
