...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/13.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Sculpture Of Three Goddess Embracing Greek Art Craft Statue</h1>
          <h4>$49.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>The Three Sisters Resin Sculpture is a perfect gift to celebrate the loving and supportive friendship among female friends, sisters, colleagues, and neighbors, and remind us of those we want to get close to or the memories we want to touch.
</p>
        </div>
    </div>
    </div>
