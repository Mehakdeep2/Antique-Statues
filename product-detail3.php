...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/4.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Vintage French/statue of the 19th century</h1>
          <h4>$129.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Vintage French/statue in regulates/The stars by Charles Ruchot/wooden base/end of the 19th century
Statue in art deco regulation, representing a young woman standing arm in the aur, dressed in a magnificent stylized drape.
The support is made of wood with a title plate: "The stars by Charles ruchot" Superb and graceful silhouette!
</p>
        </div>
    </div>
    </div>
