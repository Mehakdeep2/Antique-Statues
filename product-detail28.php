...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/Stone Sculpture/1.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Garden Statue of Four Seasons Spring</h1>
          <h4>$1999.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Charming garden sculpture of Spring from the Four Seasons, this piece portrays a woman holding a wreath of flowers and leaves which cascades down her back. Inspired by the 18th century statues from the Villa Ducale of Rivalta in Italy, this lovely piece is weathered from being outdoors and stands on a separate plinth.
</p>
        </div>
    </div>
    </div>
