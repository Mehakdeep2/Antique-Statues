...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/9.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Veiled lady bust statue - marble statue</h1>
          <h4>$249.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Also known as the veiled bride or veiled maiden, this marble sculpture was created by italian sculptor raphelle monti, who came to live and work in England 1850.
</p>
        </div>
    </div>
    </div>
