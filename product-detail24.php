...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/19.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Horse and Man Sculpture / jockey statue / figurine || Vintage solid brass</h1>
          <h4>$69.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>The perfect piece to add VINTAGE STYLE to your decor. 
</p>
        </div>
    </div>
    </div>
