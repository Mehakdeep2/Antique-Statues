...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/Marble Sculpture/2.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Marble Carved Bust James Robert Creighton Mayor Carlisle Léon-Joseph Chavalliaud</h1>
          <h4>$135.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>She is completely covered in beautiful hand carvings. She has three eyes on each head and the soles of her feet and hands. The white umbrella of protection is in Ushnisha-major Sitatapatra's hands. 
</p>
        </div>
    </div>
    </div>
