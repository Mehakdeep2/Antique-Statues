...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/12.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1> Tibetan Buddhist Vajrasattva Copper Statue</h1>
          <h4>$499.99</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Vajrasattva, the embodiment of unconditional kindness, is always portrayed with a gentle face and a luminescent countenance.
</p>
        </div>
    </div>
    </div>
