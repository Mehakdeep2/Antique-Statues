...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/8.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Real Egyptian Antiquities Scarab Original Labis Lazuli Blue Stone Egypt BC</h1>
          <h4>$2100.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>This Is the Scarab of the Kings of the Pharaohs, Made of Lapis Lazuli, Very Rare Stone That Is Distinguished by Its Blue Color and Natural Gold Granules Inside.
Very Precious Stone.
</p>
        </div>
    </div>
