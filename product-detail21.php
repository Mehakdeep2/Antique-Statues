...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/16.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Bronze Büste Frau Art deco signiert</h1>
          <h4>$175.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Verkaufe wunderschöne Bronzefigur, Darstellung einer Frau in Form einer Büste auf dunklem Sockel aus Marmor, Stil Art deco. 
</p>
        </div>
    </div>
    </div>
