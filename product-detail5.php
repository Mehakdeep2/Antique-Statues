...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/6.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Rare Antique Egyptian Silver Pendant Stone</h1>
          <h4>$100.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Bastet is depicted as a woman with a cat’s head or simply as a cat. Originally an avenging lioness deity, she evolved into a goddess of pleasure.
