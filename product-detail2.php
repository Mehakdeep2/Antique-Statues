...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/3.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Antique Bronze African Statue</h1>
          <h4>$3599.99</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>African sculpture is most often figurative, representing the human form and fashioned primarily from wood but it can also be stylized and abstracted and carved from stone and Bronze. It can span centuries and be as ancient as the advent of tools and it can be as modern as right now, today, where it is lauded and appreciated as a contemporary art form
</p>
        </div>
    </div>
    </div>
