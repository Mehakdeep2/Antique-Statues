...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/20.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>White Tara Statue (Tibetan drolma karmo ) | Authentic Himalayan Traditional Hand Carved Sculpture From Nepal | Gilded in 24k Gold | Artwork</h1>
          <h4>$4999.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Traditionally Hand Crafted Gold Gilded White Tara Indoor Statue. The figure was meticulously crafted using a copper body and gilded with 24k genuine gold over various parts of the body.
</p>
        </div>
    </div>
    </div>
