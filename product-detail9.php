...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/10.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>God Zeus Artemis Aphrodite Hermes Apollo Greek Roman Statue cast marble</h1>
          <h4>$149.99</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Cast Marble statues are made from a composite material in which natural crushed Marble stone is mixed with a small quantity of resin that works as a glue. The mixture is then poured into a mold of the statue design. Only in our sculptures 90% of the finished sculpture is natural crushed Greek Marble stone, which gives it a look and feel of solid natural marble.
</p>
        </div>
    </div>
    </div>
