...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/Plaster sculpture/1.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Plaster Elephant</h1>
          <h4>$165.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>A beautifully made English, c.1930, plaster elephant.  A delight to be viewed from any angle.  Spend time with this piece to explore the details
</p>
        </div>
    </div>
    </div>
