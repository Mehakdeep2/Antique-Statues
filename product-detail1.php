...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/2.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Antique Buddha Statue</h1>
          <h4>$369.99</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>Antique Buddha Statue - Antique Phnom Da Style Mounted Stone Khmer Buddha Head - 23cm/9" Tall.
</p>
        </div>
    </div>
    </div>
