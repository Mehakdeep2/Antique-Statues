...
<html>  
  ...
  <!--------------single product detail---------------->
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="img/statue/17.jpeg" alt="" width="500px">
      </div>
        <div class="col-2">
          <p>Home / Product</p>
          <h1>Hand Carved Wooden Native Woman Cultural Sculpture Woman Figurine</h1>
          <h4>$369.00</h4>
          <a href="cart.php" class="btn">Buy Now</a>
          <h3>Product Details <i class="fa fa-indent"></i></h3><br/>
          <p>The Sculpture is detailed and made in single piece - no joints/attachments are made in the figurine from vessel on the head to the wooden base. 
</p>
        </div>
    </div>
    </div>
